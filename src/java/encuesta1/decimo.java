...
@WebServlet(name = "decimo", urlPatterns = {"/decimo"})
public class decimo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet decimo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet decimo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
