 ...
 */
@WebServlet(name = "trece3", urlPatterns = {"/trece3"})
public class trece3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet trece3</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet trece3 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
