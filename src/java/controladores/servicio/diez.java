 ...
 */
@WebServlet(name = "diez", urlPatterns = {"/diez"})
public class diez extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet diez</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet diez at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
