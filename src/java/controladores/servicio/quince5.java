 ...
 */
@WebServlet(name = "quince5", urlPatterns = {"/quince5"})
public class quince5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet quince5</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet quince5 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
