 ...
 */
@WebServlet(name = "diesi7", urlPatterns = {"/diesi7"})
public class diesi7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet diesi7</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet diesi7 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
