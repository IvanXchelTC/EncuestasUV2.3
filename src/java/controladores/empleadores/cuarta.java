...
@WebServlet(name = "cuarta", urlPatterns = {"/cuarta"})
public class cuarta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cuarta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cuarta at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
